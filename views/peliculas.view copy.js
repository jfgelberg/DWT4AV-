...
export function crearDetallePelicula(pelicula){
    let html = ""
    html+="<h1 class='m-5 text-light text-center'>Pelicula</h1>"
    html+="<div class='container'>"
    html+="<div class=' d-flex align-items-end justify-content-end'>"
    html+="<a class='btn btn-success mb-3 text-light text-center w-100' href='/peliculas' >Atras</a>"
    html+="</div>"
    html+="<div class='container'>"
    html+="<table class='table table-dark table-striped d-flex justify-content-center'>"
    html+="<tr>"
    html+="<th>ID</th>"
    html+="<th>titulo</th>"
    html+="<th>tematica</th>"
    ...
    html+="<td style='width: 300px'  >" + pelicula.descripcion + "</td>"
